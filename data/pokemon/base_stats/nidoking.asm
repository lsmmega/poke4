	...
	; tm learnset
	tm WATER_PULSE, ROAR, TOXIC, SUNNY_DAY, ICE_BEAM, BLIZZARD, HYPER_BEAM, PROTECT, RAIN_DANCE, IRON_TAIL, THUNDERBOLT, THUNDER, EARTHQUAKE, DIG, SHADOW_BALL, DOUBLE_TEAM, SHOCK_WAVE, FLAMETHROWER, SLUDGE_BOMB, SANDSTORM, FIRE_BLAST, ROCK_TOMB, REST, ATTRACT, THIEF, FIRE_PUNCH, FURY_CUTTER, ENDURE, GIGA_IMPACT, SWAGGER, SURF, STRENGTH, ROCK_SMASH
	; end
