	...
	; tm learnset
	tm ROAR, TOXIC, SUNNY_DAY, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, GIGA_DRAIN, SAFEGUARD, SOLARBEAM, THUNDERBOLT, THUNDER, EARTHQUAKE, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, REFLECT, SLEEP_TALK, SANDSTORM, FIRE_BLAST, SWIFT, AERIAL_ACE, DREAM_EATER, DETECT, REST, STEEL_WING, NIGHTMARE, ENDURE, GIGA_IMPACT, PSYCH_UP, SWAGGER, FLY, STRENGTH, FLASH, ROCK_SMASH, FLAMETHROWER
	; end
