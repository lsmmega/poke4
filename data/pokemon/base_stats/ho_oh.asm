	...
	; tm learnset
	tm ROAR, TOXIC, SUNNY_DAY, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, GIGA_DRAIN, SAFEGUARD, SOLARBEAM, THUNDERBOLT, THUNDER, EARTHQUAKE, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, REFLECT, SHOCK_WAVE, FLAMETHROWER, SANDSTORM, FIRE_BLAST, AERIAL_ACE, REST, STEEL_WING, NIGHTMARE, ENDURE, GIGA_IMPACT, PSYCH_UP, DREAM_EATER, SWAGGER, FLY, STRENGTH, FLASH, ROCK_SMASH
	; end
