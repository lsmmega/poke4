	...
	; tm learnset
	tm WATER_PULSE, TOXIC, SUNNY_DAY, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, SAFEGUARD, DAZZLING_GLEAM, SOLARBEAM, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, REFLECT, SHOCK_WAVE, FLAMETHROWER, FIRE_BLAST, SWIFT, AERIAL_ACE, DEFENSE_CURL, DREAM_EATER, DETECT, REST, ATTRACT, STEEL_WING, ENDURE, GIGA_IMPACT, PSYCH_UP, SWAGGER, FLY, FLASH, ROCK_SMASH
	; end
