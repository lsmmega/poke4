	...
	; tm learnset
	tm WATER_PULSE, TOXIC, SUNNY_DAY, ICE_BEAM, BLIZZARD, HYPER_BEAM, PROTECT, RAIN_DANCE, SOLARBEAM, IRON_TAIL, THUNDERBOLT, THUNDER, EARTHQUAKE, DIG, SHADOW_BALL, DOUBLE_TEAM, SHOCK_WAVE, FLAMETHROWER, SANDSTORM, FIRE_BLAST, ROCK_TOMB, REST, ATTRACT, THIEF, FIRE_PUNCH, NIGHTMARE, ENDURE, GIGA_IMPACT, PSYCH_UP, DREAM_EATER, SWAGGER, CUT, SURF, STRENGTH, ROCK_SMASH
	; end
