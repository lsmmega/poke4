	...
	; tm learnset
	tm DRAGON_CLAW, WATER_PULSE, ROAR, TOXIC, BULLET_SEED, SUNNY_DAY, ICE_BEAM, BLIZZARD, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, GIGA_DRAIN, SAFEGUARD, DAZZLING_GLEAM, SOLARBEAM, IRON_TAIL, THUNDERBOLT, THUNDER, EARTHQUAKE, LOW_SWEEP, DIG, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, REFLECT, SHOCK_WAVE, FLAMETHROWER, SLUDGE_BOMB, SANDSTORM, FIRE_BLAST, ROCK_TOMB, AERIAL_ACE, REST, ATTRACT, THIEF, STEEL_WING, SCALD, FOCUS_BLAST, ENERGY_BALL, ENDURE, DRAGON_PULSE, BUG_BUZZ, GIGA_IMPACT, PSYCH_UP, DREAM_EATER, SWAGGER, CUT, FLY, SURF, STRENGTH, FLASH, ROCK_SMASH, WHIRLPOOL, WATERFALL
	; end
