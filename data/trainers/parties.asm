...
WhitneyGroup:
	...
	db 18, CLEFAIRY,   HYPER_BEAM, MIMIC, ENCORE, METRONOME
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, PROTECT, THUNDER_WAVE
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, PROTECT, THUNDER_WAVE
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, HYPER_BEAM, LOW_SWEEP, FURY_SWIPES
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, PROTECT
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, PROTECT
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, CROCONAW,   LEER, CUT, WATER_GUN, BITE
	db -1 ; end

	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 30, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, PROTECT, THUNDER_WAVE
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FERALIGATR, HYPER_BEAM, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 35, MAGNETON,   THUNDERSHOCK, PROTECT, THUNDER_WAVE, SWIFT
	...
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 36, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   THUNDERSHOCK, PROTECT, THUNDER_WAVE, SWIFT
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FERALIGATR, HYPER_BEAM, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
WillGroup:
	...
	db 41, JYNX,       GIGA_IMPACT, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
...
SchoolboyGroup:
	...
	db 35, ELECTRODE,  SCREECH, HYPER_BEAM, ROLLOUT, LIGHT_SCREEN
	...
	db 32, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, PROTECT, SUPERSONIC
...
CooltrainerMGroup:
	...
	db 26, CHARMANDER, EMBER, SMOKESCREEN, CUT, SCARY_FACE
	...
	db 27, CHARMELEON, EMBER, SMOKESCREEN, CUT, SCARY_FACE
	db -1 ; end

	; COOLTRAINERM (20)
	db "DARIN@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_PULSE, SLAM
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TOXIC, HYPER_BEAM
	...
	db 32, BEEDRILL,   FURY_ATTACK, PURSUIT, TOXIC, DOUBLE_TEAM
...
SwimmerFGroup:
	...
	db 21, HORSEA,     DRAGON_PULSE, SMOKESCREEN, LEER, WATER_GUN
	db -1 ; end
...
Rival2Group:
	...
	db 41, MAGNETON,   THUNDERSHOCK, PROTECT, THUNDER_WAVE, SWIFT
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FERALIGATR, HYPER_BEAM, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
	...
	db 45, MAGNETON,   THUNDER, PROTECT, THUNDER_WAVE, SWIFT
...
HikerGroup:
	...
	db 34, MACHOKE,    LOW_SWEEP, VITAL_THROW, HEADBUTT, DIG
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, FOCUS_BLAST, LOW_SWEEP, FOCUS_ENERGY
	db -1 ; end
	...
	db 27, HITMONCHAN, LOW_SWEEP, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end

	; BLACKBELT_T (5)
	db "NOB@", TRAINERTYPE_MOVES
	db 25, MACHOP,     LEER, FOCUS_ENERGY, LOW_SWEEP, SEISMIC_TOSS
	db 25, MACHOKE,    LEER, LOW_SWEEP, SEISMIC_TOSS, ROCK_SLIDE
	db -1 ; end
...
PicnickerGroup:
	...
	db 31, CLEFAIRY,   ENCORE, SING, HYPER_BEAM, MINIMIZE
	db -1 ; end

	; PICNICKER (17)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 37, CLEFAIRY,   ENCORE, HYPER_BEAM, MINIMIZE, METRONOME
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, CLEFAIRY,   ENCORE, SING, HYPER_BEAM, MINIMIZE
	db -1 ; end
...
TwinsGroup:
	...
	db 16, CLEFAIRY,   GROWL, ENCORE, HYPER_BEAM, METRONOME
...
MysticalmanGroup:
	...
	db 25, ELECTRODE,  SCREECH, HYPER_BEAM, THUNDER, ROLLOUT
	db -1 ; end
