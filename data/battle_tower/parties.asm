...
; BattleTowerMons group 3
	...
	db MAROWAK
	db THICK_CLUB
	db EARTHQUAKE, STRUGGLE, HYPER_BEAM, BONEMERANG
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 45000
...
; BattleTowerMons group 4
	...
	db TAUROS
	db GOLD_BERRY
	db STRUGGLE, HYPER_BEAM, EARTHQUAKE, IRON_TAIL
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 6
	...
	db GOLEM
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, STRUGGLE
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db SKARMORY
	db QUICK_CLAW
	db SANDSTORM, STEEL_WING, TOXIC, STRUGGLE
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	; Stat exp
	bigdw 50000
