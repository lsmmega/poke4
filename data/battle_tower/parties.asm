...
; BattleTowerMons group 2
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, DRAGON_PULSE, THUNDERBOLT, FIRE_BLAST
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db AERODACTYL
	db GOLD_BERRY
	db REST, HYPER_BEAM, EARTHQUAKE, DRAGON_CLAW
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	; Stat exp
	bigdw 45000
...
; BattleTowerMons group 3
	...
	db MAROWAK
	db THICK_CLUB
	db EARTHQUAKE, GIGA_IMPACT, HYPER_BEAM, BONEMERANG
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db PRIMEAPE
	db MIRACLEBERRY
	db LOW_KICK, LOW_SWEEP, REVERSAL, FOCUS_ENERGY
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 4
	...
	db TAUROS
	db GOLD_BERRY
	db GIGA_IMPACT, HYPER_BEAM, EARTHQUAKE, IRON_TAIL
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHARIZARD
	db KINGS_ROCK
	db FIRE_SPIN, DRAGON_CLAW, FLY, SLASH
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 6
	...
	db GOLEM
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, HYPER_BEAM
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db SKARMORY
	db QUICK_CLAW
	db SANDSTORM, STEEL_WING, TOXIC, CUT
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	; Stat exp
	bigdw 50000
